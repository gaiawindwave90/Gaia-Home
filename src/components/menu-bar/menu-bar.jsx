...
import themeIcon from './icons/moon.svg';
    ...
    return (
        <nav className="menu-bar">
            <ul className="menu-bar_ul">
                ...
                <li className="menu-bar_li">
                    <a className="menu-bar_a moon" id="darkModeToggle"><img src={moonIcon} alt="Moon"/></a>
                    <a className="menu-bar_a sun" id="darkModeToggle"><img src={sunIcon} alt="Sun"/></a>
                </li>
                <li className="menu-bar_li">
                ...
                <li className="menu-bar_li">
                    <a className="menu-bar_a" href="/Gaia-Home/examples">{intl ? intl.formatMessage(messages.examplesText) : "Examples"}</a>
                </li>
                <li className="menu-bar_li">
